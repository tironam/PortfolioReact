    ...
    <div className={classes.section}>
      ...
      >
        <ScrollAnimation animateIn="fadeIn" animateOut="fadeOut">
          <ProjectCard
            name="Webstacks UI Library"
            description="A UI Library designed to streamline the development of both internal work and client projects at Webstacks. Consists of atoms that define pre-set rules within the library including styling elements and spacing, molecules that cover small components that can be used anywhere including badges, buttons, and inputs, and larger components that are constructed using those molecules and atoms."
            role="Built by a team at Webstacks. I worked on many of the atoms and molecules, as well as documentation and displaying these elements in Storybook."
            tech=" TypeScript | React | Styled-Components | CSS | Storybook"
            GitHub=""
            App="https://webstacks-ui-library.netlify.app/"
          />
          <ProjectCard
            name="MCU and You"
